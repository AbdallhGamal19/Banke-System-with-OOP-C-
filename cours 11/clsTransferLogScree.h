...
private:
    ...
    static void PrintTransferLogRecordLine(clsBankeClient::stTrnsferLogRecord TransferLogRecord)
    {
...
public:
    ...
    static void ShowTransferLogScreen()
    {
        ...
        vector <clsBankeClient::stTrnsferLogRecord> vTransferLogRecord = clsBankeClient::GetTransfersLogList();
        ...
        if (vTransferLogRecord.size() == 0)
            ...
            for (clsBankeClient::stTrnsferLogRecord Record : vTransferLogRecord)
            {
