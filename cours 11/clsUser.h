...
public:
       ...
       enum enPermissions {
           eAll = -1, pListClients = 1, pAddNewClient = 2, pDeleteClient = 4, pUpdateClient = 8, pFindClient = 16, pTranactions = 32, pManageUsers = 64,pLoginRegister=128, pCurrencyExchange=256
       };
       struct stLoginRegisterRecord
       {
           string DateTime;
    ...
    bool CheckAccessPermission(enPermissions Permission) {
        ...
        if (Permission & this->_Permissions) {
            return true;
        }
        else
        {
